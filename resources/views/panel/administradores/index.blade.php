    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="pull-left">
                    <br>
                    <a href="{{route('adminpdf')}}" class="btn btn-info"><i class="zmdi zmdi-file"></i> Reporte</a>
                </div>
        ...
        <table id="tabla" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @include('panel.administradores.show')
                    @include('panel.administradores.delete')
                    @include('panel.administradores.estado')
                @endforeach
