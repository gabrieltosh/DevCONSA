        ...
        <table id="tabla" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @include('panel.empleados.show')
                    @include('panel.empleados.delete')
                    @include('panel.empleados.estado')
                @endforeach
            ...
            formatters: {
                ...
                "commands": function(column, row) {
                    if(row.activo==1)
                    {
                        ...
                        var edit="<a href=\"/panel/empleados/"+row.id+"/edit\" class=\"btn btn-icon command-edit waves-effect waves-circle\"><span style=\"color: #00bcd4;\" class=\"zmdi zmdi-edit\"></span></a> " ;
